...
public class JwtFilter extends AuthenticatingFilter {
    ...
    public JwtFilter(AuthService loginService, LoginRedisService loginRedisService, JwtProperties jwtProperties) {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        R baseResponse = R.failed(ApiCode.UNAUTHORIZED);
        HttpServletResponseUtil.printJSON(httpServletResponse, baseResponse);
        return false;
    }
